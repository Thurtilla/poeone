...
const bloodstained_fossil = new Fossil('Bloodstained Fossil', ['Has a Vaal modifier'], './img/fossils/bloodstained_icon.png','./img/fossils/special_delve_icon.png' ,'Can only be found in: Stonewood Hollow nodes', 'steelblue')
...
const faceted_fossil = new Fossil('Faceted Fossil', ['More Gem modifiers'], './img/fossils/faceted_icon.png', './img/fossils/special_delve_icon.png', 'Can only be found in: Molten Cavity nodes', 'steelblue')
const fractured_fossil = new Fossil('Fractured Fossil', ['Creates a mirrored copy'], './img/fossils/fractured_icon.png', './img/fossils/special_delve_icon.png', 'Can only be found in: Humid Fissure nodes', 'steelblue')
...
const glyphic_fossil = new Fossil('Glyphic Fossil', ['Has a Corrupt Essence modifier'], './img/fossils/glyphic_icon.png', './img/fossils/special_delve_icon.png', 'Can only be found in: Time-Lost Cavern nodes', 'steelblue')
const hollow_fossil = new Fossil('Hollow Fossil', ['Has an Abyssal socket'], './img/fossils/hollow_icon.png', './img/fossils/special_delve_icon.png', 'Can only be found in: Crystal Spire nodes', 'steelblue')
...
const tangled_fossil = new Fossil('Tangled Fossil', ['Can have any Fossil modifiers'], './img/fossils/tangled_icon.png', './img/fossils/special_delve_icon.png', 'Can only be found in: Haunted Tomb nodes', 'steelblue')
